...
* **Behavior:** Checks the embed code against the validation API endpoint (`https://superapp.supercraft.my/api/public/validate-embed`). Progress to Step 2 is blocked until a `valid` response is received.
